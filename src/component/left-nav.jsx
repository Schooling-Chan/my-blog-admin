...
class Nav extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        {/* 标题 */}
        <div className="navBox-title">博客后台管理</div>
          ...
          <li>
            <a>
              ...
              <CaretDownOutlined
                ...
                rotate={isShow && contentIndex === 0 ? 180 : 0}
              />
            </a>

            <dl
              className="navBox-ul-dl"
              style={{
                display: isShow && contentIndex === 0 ? "block" : "none",
              }}
            >
              <dd>
          ...
          <li>
            <a>
              ...
              <CaretDownOutlined
                ...
                rotate={isShow && contentIndex === 1 ? 180 : 0}
              />
            </a>
            <dl
              className="navBox-ul-dl"
              style={{
                display: isShow && contentIndex === 1 ? "block" : "none",
              }}
            >
              <dd>
                <NavLink
          ...
          <li>
            <a>
              ...
              <CaretDownOutlined
                ...
                rotate={isShow && contentIndex === 2 ? 180 : 0}
              />
            </a>
            ...
            <dl
              className="navBox-ul-dl"
              style={{
                display: isShow && contentIndex === 2 ? "block" : "none",
              }}
            >
              <dd>
                <NavLink
          ...
          <li>
            <a>
              ...
              <CaretDownOutlined
                ...
                rotate={isShow && contentIndex === 3 ? 180 : 0}
              />
            </a>
            ...
            <dl
              className="navBox-ul-dl"
              style={{
                display: isShow && contentIndex === 3 ? "block" : "none",
              }}
            >
              <dd>
                <NavLink to="/sets/basic" activeClassName="navBox-ul-dl-active">
                  基本资料
                </NavLink>
              </dd>
              <dd>
