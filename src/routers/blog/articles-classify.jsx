    ...
    >
      ...
      <div className="content-head">
        ...
        >
          <li>
            <a
              className={clickState === "HTML" ? "content-head-active" : ""}
              data-attr="HTML"
            >
              HTML
            </a>
          ...
          <li>
            <a
              className={clickState === "CSS" ? "content-head-active" : ""}
              data-attr="CSS"
            >
              CSS
            </a>
          ...
          <li>
            <a
              className={clickState === "JS" ? "content-head-active" : ""}
              data-attr="JS"
            >
              JS
            </a>
          ...
          <li>
            <a
              className={clickState === "React" ? "content-head-active" : ""}
              data-attr="React"
            >
              React
            </a>
          ...
          <li>
            <a
              className={clickState === "Node" ? "content-head-active" : ""}
              data-attr="Node"
            >
              Node
            </a>
